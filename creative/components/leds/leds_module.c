...
static char *check_arg(int argc, char **argv, int max_param_num,
                float param[]) {
    bzero((void*)param, 10);
    int k = 0;
...
static int check_led_pulse(int argc, char **argv, float param[]) {
    if (argc > 4) {
...
static int led_pulse(int argc, char **argv, float *param) {
